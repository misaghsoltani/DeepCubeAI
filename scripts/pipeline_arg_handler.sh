...
handle_offline_data_vars() {
    ...
    DCAI_OFFLINE_DIR=data/${DCAI_DATA_DIR}/offline
    DCAI_OFFLINE_ENC_DIR=data/${DCAI_DATA_DIR}/offline_enc
    DCAI_OFFLINE_ENV_TEST_DIR=data/${DCAI_DATA_DIR}/model_test
...
handle_model_test_vars() {
    ...
    if [ -z "$DCAI_MODEL_TEST_DATA" ]; then
        echo "WARNING: The argument '--model_test_data_dir' was not given. By default, the following path will be used:"
...
handle_env_model_vars() {
    DCAI_ENV_MODEL_SAVE_DIR=saved_env_models
...
handle_heur_model_vars() {
    DCAI_HEUR_MODEL_SAVE_DIR=saved_heur_models
...
handle_qstar_vars() {
    ...
    DCAI_RESULTS_DIR="results/${DCAI_ENV}/${DCAI_QSTAR_RESULTS_DIR:-"model=${DCAI_ENV_MODEL_NAME}_heur=${DCAI_HEUR_NNET_NAME}_QSTAR_results/path_cost_weight=${DCAI_QSTAR_WEIGHT}__h_weight=${DCAI_QSTAR_H_WEIGHT}"}"
}
...
handle_ucs_vars() {
    ...
    DCAI_RESULTS_DIR="results/${DCAI_ENV}/${DCAI_UCS_RESULTS_DIR:-"model=${DCAI_ENV_MODEL_NAME}_UCS_results"}"
}
...
handle_gbfs_vars() {
    ...
    DCAI_RESULTS_DIR="results/${DCAI_ENV}/${DCAI_GBFS_RESULTS_DIR:-"model=${DCAI_ENV_MODEL_NAME}_heur=${DCAI_HEUR_NNET_NAME}_GBFS_results"}"
}
