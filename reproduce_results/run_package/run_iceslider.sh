...
deepcubeai --stage ucs --env $ENV --data_dir $DATA_DIR --data_file_name $DATA_FILE_NAME_SEARCH_TEST --env_model_name $ENV_MODEL_NAME_DISC --ucs_batch_size $UCS_BATCH_SIZE --per_eq_tol $PER_EQ_TOL --ucs_results_dir $RESULTS_DIR_UCS --save_imgs true
