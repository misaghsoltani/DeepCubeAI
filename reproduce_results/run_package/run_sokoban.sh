...
deepcubeai --stage ucs --env $ENV --env_model_name $ENV_MODEL_NAME_DISC --ucs_batch_size $UCS_BATCH_SIZE --per_eq_tol $PER_EQ_TOL --ucs_results_dir $RESULTS_DIR_UCS --search_test_data $SEARCH_TEST_DATA --save_imgs false
